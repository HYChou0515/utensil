...
class TestDefaultConstant(ut.TestCase):
    ...
    def test_PROJECT_ConfigPath(self):
        reload(constant)
        self.assertEqual(
            os.path.join(self.project_root, "utensil.ini"),
            constant.PROJECT["ConfigPath"],
        )
    ...
    def test_LOG_Dir(self):
        reload(constant)
        self.assertEqual(os.path.join(self.project_root, ".utensil", "log"),
                         constant.LOG["Dir"])
    ...
    def test_LOG_FilePrefix(self):
        reload(constant)
        self.assertEqual(
            os.path.join(self.project_root, ".utensil", "log", ".utensil.log"),
            constant.LOG["FilePrefix"],
        )
...
class TestModifiedConstant(ut.TestCase):
    ...
    def test_PROJECT_ConfigPath(self):
        reload(constant)
        self.assertEqual(
            os.path.join(self.project_root, self.utensil_config),
            constant.PROJECT["ConfigPath"],
        )
    ...
    def test_LOG_Dir(self):
        reload(constant)
        self.assertEqual(os.path.join("proj_name_proj_abbr", "log_test"),
                         constant.LOG["Dir"])
    ...
    def test_LOG_FilePrefix(self):
        reload(constant)
        self.assertEqual(
            os.path.join("proj_name_proj_abbr", "log_test", "proj_name.log123"),
            constant.LOG["FilePrefix"],
        )
